<?php
	...
	$ArrayTravel = $this->Schedule_model->GetDetail($ParamTravel);
?>
<title>Laporan Travel - Detail</title>
<style>
...
<div>
	<div style="text-align: center; padding: 0 0 20px 0;">
		<div style="font-size: 28px;">Laporan Travel Detail</div>
		...
		<?php if (count($ArrayTravel) > 0) { ?>
			<table style="width: 100%;">
				...
				<?php foreach ($ArrayTravel as $Array) { ?>
					<?php $Total += $Array['reservasi_total']; ?>
					<tr>
						...
						<td class="right"><?php echo MoneyFormat($Array['reservasi_total']); ?></td>
					</tr>
				<?php } ?>
					<tr>
